...
```*/
    ...
    impl alloy_sol_types::SolInterface for ITangleCalls {
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<ITangleCalls>] = &[
                {
                    fn serviceCount(
                        data: &[u8],
                ...
                },
                {
                    fn unregisterOperator(
                        ...
                        <unregisterOperatorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ITangleCalls::unregisterOperator)
                    }
                    unregisterOperator
                },
                {
                ...
                },
                {
                    fn getOperatorPublicKey(
                        ...
                        <getOperatorPublicKeyCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ITangleCalls::getOperatorPublicKey)
                    }
                    getOperatorPublicKey
                },
                {
                    fn submitJobs(data: &[u8]) -> alloy_sol_types::Result<ITangleCalls> {
                        <submitJobsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                                data,
                            )
                            .map(ITangleCalls::submitJobs)
                    }
                    submitJobs
                },
                {
                    fn approveServiceWithCommitments(
                        ...
                        <approveServiceWithCommitmentsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ITangleCalls::approveServiceWithCommitments)
                    }
                ...
                },
                {
                    fn isPermittedCaller(
                        ...
                        <isPermittedCallerCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ITangleCalls::isPermittedCaller)
                    }
                    isPermittedCaller
                },
                {
                    fn isServiceActive(
                        ...
                        <isServiceActiveCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ITangleCalls::isServiceActive)
                    }
                    isServiceActive
                },
                {
                    fn pendingRewards(
                        ...
                        <pendingRewardsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ITangleCalls::pendingRewards)
                    }
                    pendingRewards
                },
                {
                ...
                },
                {
                    fn getServiceTotalExposure(
                        ...
                        <getServiceTotalExposureCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ITangleCalls::getServiceTotalExposure)
                    }
                ...
                },
                {
                    fn deactivateBlueprint(
                        ...
                        <deactivateBlueprintCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ITangleCalls::deactivateBlueprint)
                    }
                    deactivateBlueprint
                },
                {
                    fn getBlueprintConfig(
                        ...
                        <getBlueprintConfigCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ITangleCalls::getBlueprintConfig)
                    }
                    getBlueprintConfig
                },
                {
                ...
                },
                {
                    fn removePermittedCaller(
                        ...
                        <removePermittedCallerCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ITangleCalls::removePermittedCaller)
                    }
                ...
                },
                {
                    fn getServiceRequest(
                        ...
                        <getServiceRequestCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ITangleCalls::getServiceRequest)
                    }
                    getServiceRequest
                },
                {
                    fn approveService(
                        ...
                        <approveServiceCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ITangleCalls::approveService)
                    }
                    approveService
                },
                {
                    fn isOperatorRegistered(
                        ...
                        <isOperatorRegisteredCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ITangleCalls::isOperatorRegistered)
                    }
                ...
                },
                {
                    fn getOperatorRegistration(
                        ...
                        <getOperatorRegistrationCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ITangleCalls::getOperatorRegistration)
                    }
                ...
                },
                {
                    fn rejectService(
                        ...
                        <rejectServiceCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ITangleCalls::rejectService)
                    }
                    rejectService
                },
                {
                ...
                },
                {
                    fn createBlueprintWithConfig(
                        ...
                        <createBlueprintWithConfigCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ITangleCalls::createBlueprintWithConfig)
                    }
                ...
                },
                {
                    fn setOperatorOnline(
                        ...
                        <setOperatorOnlineCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ITangleCalls::setOperatorOnline)
                    }
                    setOperatorOnline
                },
                {
                    fn addPermittedCaller(
                        ...
                        <addPermittedCallerCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ITangleCalls::addPermittedCaller)
                    }
                    addPermittedCaller
                },
                {
                ...
                },
                {
                    fn transferBlueprint(
                        ...
                        <transferBlueprintCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ITangleCalls::transferBlueprint)
                    }
                    transferBlueprint
                },
                {
                ...
                },
                {
                    fn updateOperatorPreferences(
                        ...
                        <updateOperatorPreferencesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ITangleCalls::updateOperatorPreferences)
                    }
                ...
                },
                {
                    fn requestService(
                        ...
                        <requestServiceCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ITangleCalls::requestService)
                    }
                    requestService
                },
                {
                    fn isServiceOperator(
                        ...
                        <isServiceOperatorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ITangleCalls::isServiceOperator)
                    }
                    isServiceOperator
                },
                {
                    fn getJobCall(data: &[u8]) -> alloy_sol_types::Result<ITangleCalls> {
                        <getJobCallCall as alloy_sol_types::SolCall>::abi_decode_raw(
                                data,
                            )
                            .map(ITangleCalls::getJobCall)
                    }
                    getJobCall
                },
                {
                    fn submitResults(
                        ...
                        <submitResultsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ITangleCalls::submitResults)
                    }
                    submitResults
                },
                {
                ...
                },
                {
                    fn getServiceOperators(
                        ...
                        <getServiceOperatorsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ITangleCalls::getServiceOperators)
                    }
                    getServiceOperators
                },
                {
                    fn submitAggregatedResult(
                        ...
                        <submitAggregatedResultCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ITangleCalls::submitAggregatedResult)
                    }
                ...
                },
                {
                    fn blueprintCount(
                        ...
                        <blueprintCountCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ITangleCalls::blueprintCount)
                    }
                    blueprintCount
                },
                {
                    fn billSubscription(
                        ...
                        <billSubscriptionCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ITangleCalls::billSubscription)
                    }
                    billSubscription
                },
                {
                ...
                },
                {
                    fn updateBlueprint(
                        ...
                        <updateBlueprintCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ITangleCalls::updateBlueprint)
                    }
                    updateBlueprint
                },
                {
                ...
                },
                {
                    fn getOperatorPreferences(
                        ...
                        <getOperatorPreferencesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ITangleCalls::getOperatorPreferences)
                    }
    ...
    ///Container for all the [`ITangle`](self) events.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for ITangleEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`ITangle`](self) contract instance.

See the [wrapper's documentation](`ITangleInstance`) for more details.*/
    #[inline]
    pub const fn new<
        P: alloy_contract::private::Provider<N>,
        N: alloy_contract::private::Network,
    >(
        ...
        ITangleInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<ITangleInstance<P, N>>,
    > {
        ITangleInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        ITangleInstance::<P, N>::deploy_builder(__provider)
    }
    /**A [`ITangle`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`ITangle`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct ITangleInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for ITangleInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("ITangleInstance").field(&self.address).finish()
        }
    }
    /// Instantiation and getters/setters.
    impl<
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<ITangleInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> ITangleInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
