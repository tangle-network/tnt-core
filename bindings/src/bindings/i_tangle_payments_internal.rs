...
interface ITanglePaymentsInternal {
    ...
    function distributePayment(uint64 serviceId, uint64 blueprintId, address token, uint256 amount, address[] memory operators, uint16[] memory exposures, uint256 totalExposure) external;
}
```
...
```*/
    ...
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Default, Debug, PartialEq, Eq, Hash)]
    /**Function with signature `distributePayment(uint64,uint64,address,uint256,address[],uint16[],uint256)` and selector `0xea0f316b`.
```solidity
function distributePayment(uint64 serviceId, uint64 blueprintId, address token, uint256 amount, address[] memory operators, uint16[] memory exposures, uint256 totalExposure) external;
```*/
    #[allow(non_camel_case_types, non_snake_case, clippy::pub_underscore_fields)]
    ...
    pub struct distributePaymentCall {
        ...
        #[allow(missing_docs)]
        pub totalExposure: alloy::sol_types::private::primitives::aliases::U256,
    }
    ///Container type for the return parameters of the [`distributePayment(uint64,uint64,address,uint256,address[],uint16[],uint256)`](distributePaymentCall) function.
    #[allow(non_camel_case_types, non_snake_case, clippy::pub_underscore_fields)]
    #[derive(Clone)]
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for distributePaymentCall {
            ...
            type ReturnToken<'a> = <Self::ReturnTuple<
                'a,
            > as alloy_sol_types::SolType>::Token<'a>;
            const SIGNATURE: &'static str = "distributePayment(uint64,uint64,address,uint256,address[],uint16[],uint256)";
            const SELECTOR: [u8; 4] = [234u8, 15u8, 49u8, 107u8];
            #[inline]
            fn new<'a>(
                tuple: <Self::Parameters<'a> as alloy_sol_types::SolType>::RustType,
            ) -> Self {
            ...
            fn tokenize(&self) -> Self::Token<'_> {
                (
                    ...
                    <alloy::sol_types::sol_data::Uint<
                        256,
                    > as alloy_sol_types::SolType>::tokenize(&self.totalExposure),
                )
            }
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    > ITanglePaymentsInternalInstance<P, N> {
        ...
        pub fn distributePayment(
            ...
            totalExposure: alloy::sol_types::private::primitives::aliases::U256,
