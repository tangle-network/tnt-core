...
const ensureNativeOperator = async (context: HandlerContext, address: string, timestamp: bigint) => {
...
const trackNativeOperatorDelegation = async (context: HandlerContext, operatorId: string, amountDelta: bigint, timestamp: bigint) => {
