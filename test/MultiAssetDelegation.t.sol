...
contract MultiAssetDelegationTest is Test {
    ...
    /// @notice Helper to register operator and enable delegation
    function _registerOperatorOpen(address operator, uint256 stake) internal {
        vm.prank(operator);
    ...
    function test_Delegate() public {
        // Setup operator with delegation enabled
        _registerOperatorOpen(operator1, MIN_OPERATOR_STAKE);
    ...
    function test_DelegateMultipleOperators() public {
        _registerOperatorOpen(operator1, MIN_OPERATOR_STAKE);
        _registerOperatorOpen(operator2, MIN_OPERATOR_STAKE);
    ...
    function test_SlashForService_SlashesPoolDelegations() public {
        // Setup operator with delegation enabled
        _registerOperatorOpen(operator1, 10 ether);
    ...
    function test_GetOperatorStake() public {
        _registerOperatorOpen(operator1, 5 ether);
