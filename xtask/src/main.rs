    ...
    run_with_progress(
        Command::new("forge")
            ...
            .args([
                ...
                "src/interfaces/ITangleGovernance.sol",
                "src/interfaces/ITanglePaymentsInternal.sol",
                "src/interfaces/ITangleSecurityView.sol",
                "src/interfaces/IBlueprintServiceManager.sol",
                "src/interfaces/IMasterBlueprintServiceManager.sol",
