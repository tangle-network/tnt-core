...
/// @notice Cross-chain enabled BlueprintServiceManager that dispatches messages through a bridge manager
contract XCBlueprintServiceManager is BlueprintServiceManagerBase {
    ...
    /// @notice Internal function to safely dispatch a cross-chain message
    ...
    /// @notice Override of onSlash to dispatch slash events cross-chain
    ...
    /// @notice Override of onJobResult to dispatch job result events cross-chain
    ...
    /// @notice Function to receive ETH for bridge fees
