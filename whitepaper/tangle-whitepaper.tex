...
\begin{enumerate}
    ...
    \item Castro, M., \& Liskov, B. (1999). Practical Byzantine Fault Tolerance. \textit{OSDI '99}.

    \item Gennaro, R., Jarecki, S., Krawczyk, H., \& Rabin, T. (1999). Secure Distributed Key Generation for Discrete-Log Based Cryptosystems. \textit{EUROCRYPT '99}.

    \item Boldyreva, A. (2003). Threshold Signatures, Multisignatures and Blind Signatures Based on the Gap-Diffie-Hellman-Group Signature Scheme. \textit{PKC '03}.
